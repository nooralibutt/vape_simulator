...
namespace FlutterUnityIntegration
{
    ...
    public class UnityMessageManager : SingletonMonoBehaviour<UnityMessageManager>
    {
        ...
        {
            UnityMessageManager.Instance.SendMessageToFlutter("onFlutterMessage called withh  message" + message);
            ...
            UnityMessageManager.Instance.SendMessageToFlutter("OnFlutterMessage field valaue: " + OnFlutterMessage);
